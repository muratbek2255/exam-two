...
for item in students:
    if item['course'] == 'python':
        python_students.append(item["name"])
    elif item['course'] == 'javascript':
        javascript_students.append(item["name"])
    elif item['course'] == 'java':
        java_students.append(item["name"])
...
for item in students:
    names_ages.append(item["name"])
    names_ages.append(item["age"])
...
names34 = ['Janyl', 'Nursultan', 'Meerim', 'Emir', 'Susann', 'Marcus', 'Aidin',
...
def func(names34, names_ages):
    for i in names34:
        if i in names_ages:
            print(f'{i}')


print(func(names34, names_ages))